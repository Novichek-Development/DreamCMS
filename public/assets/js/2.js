...
/***/ "./resources/js/skinview3d.module.js":
/*!*******************************************!*\
  !*** ./resources/js/skinview3d.module.js ***!
  \*******************************************/
...
function toFaceVertices(x1, y1, x2, y2, w, h) {
  return [new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x1 / w, 1.0 - y2 / h), new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x2 / w, 1.0 - y2 / h), new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x2 / w, 1.0 - y1 / h), new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x1 / w, 1.0 - y1 / h)];
}
...
var SkinObject = /** @class */function (_super) {
  ...
  SkinObject.prototype.getBodyParts = function () {
    return this.children.filter(function (it) {
      return it instanceof BodyPart;
    });
  };
  SkinObject.prototype.setInnerLayerVisible = function (value) {
    this.getBodyParts().forEach(function (part) {
      return part.innerLayer.visible = value;
    });
  };
  SkinObject.prototype.setOuterLayerVisible = function (value) {
    this.getBodyParts().forEach(function (part) {
      return part.outerLayer.visible = value;
    });
  };
  return SkinObject;
}(three__WEBPACK_IMPORTED_MODULE_0__["Group"]);
...
function isSlimSkin(canvasOrImage) {
  ...
  if (canvasOrImage instanceof HTMLCanvasElement) {
    ...
    var checkArea = function checkArea(x, y, w, h) {
      return hasTransparency(context_1, x * scale_2, y * scale_2, w * scale_2, h * scale_2);
    };
...
var SkinViewer = /** @class */function () {
  function SkinViewer(options) {
    ...
    this.layer1Material = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({
      map: this.skinTexture,
      side: three__WEBPACK_IMPORTED_MODULE_0__["FrontSide"]
    });
    this.layer2Material = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({
      map: this.skinTexture,
      transparent: true,
      opacity: 1,
    ...
    this.capeMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({
