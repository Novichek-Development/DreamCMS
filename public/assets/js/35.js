...
/***/ "./node_modules/skinview3d/dist/skinview3d.module.js":
/*!***********************************************************!*\
  !*** ./node_modules/skinview3d/dist/skinview3d.module.js ***!
  \***********************************************************/
/*! exports provided: BodyPart, CapeObject, CompositeAnimation, OrbitControls, PlayerObject, RotatingAnimation, RunningAnimation, SkinObject, SkinViewer, WalkingAnimation, createOrbitControls, invokeAnimation, isSlimSkin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BodyPart", function() { return BodyPart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CapeObject", function() { return CapeObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompositeAnimation", function() { return CompositeAnimation; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RotatingAnimation", function() { return RotatingAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RunningAnimation", function() { return RunningAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SkinObject", function() { return SkinObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SkinViewer", function() { return SkinViewer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WalkingAnimation", function() { return WalkingAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createOrbitControls", function() { return createOrbitControls; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "invokeAnimation", function() { return invokeAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSlimSkin", function() { return isSlimSkin; });
...
function toFaceVertices(x1, y1, x2, y2, w, h) {
    return [
        new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x1 / w, 1.0 - y2 / h),
        new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x2 / w, 1.0 - y2 / h),
        new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x2 / w, 1.0 - y1 / h),
        new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](x1 / w, 1.0 - y1 / h)
    ];
}
...
var SkinObject = /** @class */ (function (_super) {
    ...
    function SkinObject(layer1Material, layer2Material) {
        ...
        _this._slim = false;
        // Head
        var headBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](8, 8, 8, 0, 0, 0);
        ...
        var headMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](headBox, layer1Material);
        var head2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](9, 9, 9, 0, 0, 0);
        ...
        var head2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](head2Box, layer2Material);
        ...
        // Body
        var bodyBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](8, 12, 4, 0, 0, 0);
        ...
        var bodyMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](bodyBox, layer1Material);
        var body2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](9, 13.5, 4.5, 0, 0, 0);
        ...
        var body2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](body2Box, layer2Material);
        ...
        // Right Arm
        var rightArmBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](1, 1, 1, 0, 0, 0); // w/d/h is model-related
        var rightArmMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](rightArmBox, layer1Material);
        ...
        var rightArm2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](1, 1, 1, 0, 0, 0); // w/d/h is model-related
        var rightArm2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](rightArm2Box, layer2Material);
        ...
        var rightArmPivot = new three__WEBPACK_IMPORTED_MODULE_0__["Group"]();
        ...
        // Left Arm
        var leftArmBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](1, 1, 1, 0, 0, 0); // w/d/h is model-related
        var leftArmMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](leftArmBox, layer1Material);
        _this.modelListeners.push(function () {
        ...
        var leftArm2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](1, 1, 1, 0, 0, 0); // w/d/h is model-related
        var leftArm2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](leftArm2Box, layer2Material);
        ...
        var leftArmPivot = new three__WEBPACK_IMPORTED_MODULE_0__["Group"]();
        ...
        // Right Leg
        var rightLegBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](4 - esp, 12 - esp, 4 - esp, 0, 0, 0);
        ...
        var rightLegMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](rightLegBox, layer1Material);
        var rightLeg2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](4.5 - esp, 13.5 - esp, 4.5 - esp, 0, 0, 0);
        ...
        var rightLeg2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](rightLeg2Box, layer2Material);
        rightLeg2Mesh.renderOrder = 1;
        var rightLegPivot = new three__WEBPACK_IMPORTED_MODULE_0__["Group"]();
        ...
        // Left Leg
        var leftLegBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](4 - esp, 12 - esp, 4 - esp, 0, 0, 0);
        ...
        var leftLegMesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](leftLegBox, layer1Material);
        var leftLeg2Box = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](4.5 - esp, 13.5 - esp, 4.5 - esp, 0, 0, 0);
        ...
        var leftLeg2Mesh = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](leftLeg2Box, layer2Material);
        leftLeg2Mesh.renderOrder = 1;
        var leftLegPivot = new three__WEBPACK_IMPORTED_MODULE_0__["Group"]();
...
var CapeObject = /** @class */ (function (_super) {
    ...
    function CapeObject(capeMaterial) {
        ...
        // back = outside
        // front = inside
        var capeBox = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](10, 16, 1, 0, 0, 0);
        ...
        _this.cape = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](capeBox, capeMaterial);
...
var SkinViewer = /** @class */ (function () {
    function SkinViewer(options) {
        ...
        this.skinTexture = new three__WEBPACK_IMPORTED_MODULE_0__["Texture"](this.skinCanvas);
        this.skinTexture.magFilter = three__WEBPACK_IMPORTED_MODULE_0__["NearestFilter"];
        this.skinTexture.minFilter = three__WEBPACK_IMPORTED_MODULE_0__["NearestFilter"];
        this.capeImg = new Image();
        this.capeCanvas = document.createElement("canvas");
        this.capeTexture = new three__WEBPACK_IMPORTED_MODULE_0__["Texture"](this.capeCanvas);
        this.capeTexture.magFilter = three__WEBPACK_IMPORTED_MODULE_0__["NearestFilter"];
        this.capeTexture.minFilter = three__WEBPACK_IMPORTED_MODULE_0__["NearestFilter"];
        this.layer1Material = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({ map: this.skinTexture, side: three__WEBPACK_IMPORTED_MODULE_0__["FrontSide"] });
        this.layer2Material = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({ map: this.skinTexture, transparent: true, opacity: 1, side: three__WEBPACK_IMPORTED_MODULE_0__["DoubleSide"], alphaTest: 0.5 });
        this.capeMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({ map: this.capeTexture, transparent: true, opacity: 1, side: three__WEBPACK_IMPORTED_MODULE_0__["DoubleSide"], alphaTest: 0.5 });
        // scene
        this.scene = new three__WEBPACK_IMPORTED_MODULE_0__["Scene"]();
        // Use smaller fov to avoid distortion
        this.camera = new three__WEBPACK_IMPORTED_MODULE_0__["PerspectiveCamera"](40);
        this.camera.position.y = -12;
        this.camera.position.z = 60;
        this.renderer = new three__WEBPACK_IMPORTED_MODULE_0__["WebGLRenderer"]({ alpha: true, antialias: false });
...
var OrbitControls = /** @class */ (function (_super) {
    ...
    function OrbitControls(object, domElement, domWindow) {
        ...
        // Mouse buttons
        _this.mouseButtons = { ORBIT: three__WEBPACK_IMPORTED_MODULE_0__["MOUSE"].LEFT, ZOOM: three__WEBPACK_IMPORTED_MODULE_0__["MOUSE"].MIDDLE, PAN: three__WEBPACK_IMPORTED_MODULE_0__["MOUSE"].RIGHT };
        // for reset
        _this.target0 = _this.target.clone();
        _this.position0 = _this.object.position.clone();
        _this.zoom0 = _this.object.zoom;
        // for update speedup
        _this.updateOffset = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
        // so camera.up is the orbit axis
        _this.updateQuat = new three__WEBPACK_IMPORTED_MODULE_0__["Quaternion"]().setFromUnitVectors(object.up, new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 1, 0));
        _this.updateQuatInverse = _this.updateQuat.clone().inverse();
        _this.updateLastPosition = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
        _this.updateLastQuaternion = new three__WEBPACK_IMPORTED_MODULE_0__["Quaternion"]();
        _this.state = STATE.NONE;
        _this.scale = 1;
        // current position in spherical coordinates
        _this.spherical = new three__WEBPACK_IMPORTED_MODULE_0__["Spherical"]();
        _this.sphericalDelta = new three__WEBPACK_IMPORTED_MODULE_0__["Spherical"]();
        _this.panOffset = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
        ...
        _this.panDelta = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]();
        _this.dollyStart = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]();
        _this.dollyEnd = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]();
        _this.dollyDelta = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]();
        _this.panLeftV = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
        _this.panUpV = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
        _this.panInternalOffset = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
    ...
    OrbitControls.prototype.pan = function (deltaX, deltaY) {
        ...
        if (this.object instanceof three__WEBPACK_IMPORTED_MODULE_0__["PerspectiveCamera"]) {
            // perspective
            var position = this.object.position;
        ...
        else if (this.object instanceof three__WEBPACK_IMPORTED_MODULE_0__["OrthographicCamera"]) {
            // orthographic
...
function createOrbitControls(skinViewer) {
    ...
    control.target = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, -12, 0);
