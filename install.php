...
runCheckedCommand("./composer.phar install");

msg_header("INSTALL NPM PACKAGES");
runCheckedCommand("npm install");

msg_header("UNPACK FONTAWESOME");
runCheckedCommand("tar -xf fa.tar -C node_modules/");
...
msg("It can take some time...", WARNING);
runCheckedCommand("cd vuexy && npm install && npm run prod");
