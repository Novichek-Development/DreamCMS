        ...
        <div class="chat_color col-12 col-lg-6 mt-5 mt-lg-0" :class="!hasPermission('prefix.text.edit') && !hasPermission('prefix.prefix_color.edit') && !hasPermission('prefix.nick_color.edit') && !hasPermission('prefix.msg_color.edit') ? 'locked' : ''">
            <div class="section">
                ...
                <div class="footer" v-html="">
                    <span style="color: #555">[</span> <span :style="'color: ' + this.getColor(prefix.prefix_color).hex">{{ prefix.text }}</span> <span style="color: #555">]</span> <span :style="'color: ' + this.getColor(prefix.nick_color).hex">{{ user.login }}</span> <span style="color: #555">: </span> <span :style="'color: ' + this.getColor(prefix.msg_color).hex">Алоха, друзья!</span>
                    <br><span style="color: #555">[</span> <span :style="'color: ' + this.getColor(prefix.prefix_color).hex">{{ prefix.text }}</span> <span style="color: #555">]</span> <span :style="'color: ' + this.getColor(prefix.nick_color).hex">{{ user.login }}</span> <span style="color: #555">: </span> <span :style="'color: ' + this.getColor(prefix.msg_color).hex">Как ваши дела?</span>
                    <br><span style="color: #555">[</span> <span :style="'color: ' + this.getColor(prefix.prefix_color).hex">{{ prefix.text }}</span> <span style="color: #555">]</span> <span :style="'color: ' + this.getColor(prefix.nick_color).hex">{{ user.login }}</span> <span style="color: #555">: </span> <span :style="'color: ' + this.getColor(prefix.msg_color).hex">Я люблю Ave MC!</span>
