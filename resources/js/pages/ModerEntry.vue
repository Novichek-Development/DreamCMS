<template>
    <div :class="'inner ' + (this.loading ? 'unload' : '')">
        <div class="headline text-center">
            ...
            <p>Команда проекта — стабильна и решительна к великим действиям, умеет оперативно реагировать на различные ситуации и решать их в короткие сроки.</p>
        </div>
        <div class="moder">
            <div class="section primary">
                <h3>Заявка в команду проекта</h3>
                <p>Хочешь отличиться среди прочих и считаешь, что именно ты готов на великие свершения? Звание одного из членов команды — это отличная возможность проверить себя и свои силы! </p>
                ...
                <div class="fieldset current" v-if="current">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            <h5>О себе (желаемая должность)</h5>
                        </div>
                        <div class="col">
