<template>
    <div :class="loading ? 'unload' : ''">
        <div class="section economy">
            ...
            <p>Нарушая правила, вы получаете блокировку на всех наших серверах. Если вы поняли свою ошибку и хотите исправиться, вы можете приобрести досрочную моментальную разблокировку. С каждой блокировкой, стоимость разбана увеличивается на 50 эйвов!</p>
            <p>
