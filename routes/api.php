...
Route::post('/pay/interkassa', "\App\Http\Controllers\PaymentController@interkassa");
Route::post('/pay/freekassa', "\App\Http\Controllers\PaymentController@freekassa");
Route::post('/pay/qiwip2p', "\App\Http\Controllers\PaymentController@qiwip2p");
...
Route::prefix('top')->group(function (){
    Route::post('money', 'TopController@topByMoney');
    Route::post('votes', 'TopController@topByVotes');
});
...
Route::prefix('profile')->middleware('auth')->group(function (){
    ...
    Route::get('refers', "ProfileController@refers");
